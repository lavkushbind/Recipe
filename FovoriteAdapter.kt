...
class FovoriteAdapter(
    private val context: Context,
    private val postList: List<Details>
) : RecyclerView.Adapter<FovoriteAdapter.ViewHolder>() {
...
//            intent.putExtra("itemData", post) // Pass the item data to the new activity
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val imageView: ImageView = itemView.findViewById(R.id.text_catgries)
        val titleTextView: TextView = itemView.findViewById(R.id.image_catgries)
